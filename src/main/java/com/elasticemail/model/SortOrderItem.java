...
public class SortOrderItem {
  ...
  public SortOrderItem publicInboundId(@javax.annotation.Nonnull String publicInboundId) {
  ...
  public void setPublicInboundId(@javax.annotation.Nonnull String publicInboundId) {
    this.publicInboundId = publicInboundId;
  }


  public SortOrderItem sortOrder(@javax.annotation.Nonnull Integer sortOrder) {
  ...
  static {
    ...
    openapiFields.add("PublicInboundId");
    openapiFields.add("SortOrder");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("PublicInboundId");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SortOrderItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SortOrderItem is not found in the empty JSON string", SortOrderItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SortOrderItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SortOrderItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SortOrderItem.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("PublicInboundId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `PublicInboundId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("PublicInboundId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SortOrderItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SortOrderItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SortOrderItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SortOrderItem.class));

       return (TypeAdapter<T>) new TypeAdapter<SortOrderItem>() {
           @Override
           public void write(JsonWriter out, SortOrderItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SortOrderItem read(JsonReader in) throws IOException {

...
public enum TemplateType {
  ...
  LANDING_PAGE_PAYMENT_CONFIRMATION_TEMPLATE("LandingPagePaymentConfirmationTemplate"),
  
  LANDING_PAGE_NEWSLETTER_PRODUCT_TEMPLATE("LandingPageNewsletterProductTemplate"),
  
  LANDING_PAGE_NEWSLETTER_PAYMENT_CONFIRMATION_TEMPLATE("LandingPageNewsletterPaymentConfirmationTemplate"),
  
  NEWSLETTER_SUBSCRIPTION_CANCELLATION_TEMPLATE("NewsletterSubscriptionCancellationTemplate");

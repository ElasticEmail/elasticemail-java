...
public class TemplatePayload {
  ...
  public TemplatePayload name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public TemplatePayload subject(@javax.annotation.Nullable String subject) {
  ...
  public TemplatePayload body(@javax.annotation.Nullable List<BodyPart> body) {
    this.body = body;
    return this;
  }
  ...
  public TemplatePayload templateScope(@javax.annotation.Nullable TemplateScope templateScope) {

...
public class EmailSend {
  ...
  public EmailSend transactionID(@javax.annotation.Nullable String transactionID) {
  ...
  public EmailSend messageID(@javax.annotation.Nullable String messageID) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailSend.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailSend is not found in the empty JSON string", EmailSend.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailSend.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailSend` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailSend.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailSend' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailSend> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailSend.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailSend>() {
           @Override
           public void write(JsonWriter out, EmailSend value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailSend read(JsonReader in) throws IOException {

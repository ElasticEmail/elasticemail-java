...
public class ChannelLogStatusSummary {
  ...
  public boolean equals(Object o) {
    ...
    ChannelLogStatusSummary channelLogStatusSummary = (ChannelLogStatusSummary) o;
    return Objects.equals(this.channelName, channelLogStatusSummary.channelName) &&
        Objects.equals(this.recipients, channelLogStatusSummary.recipients) &&
        Objects.equals(this.emailTotal, channelLogStatusSummary.emailTotal) &&
        Objects.equals(this.smsTotal, channelLogStatusSummary.smsTotal) &&
        Objects.equals(this.delivered, channelLogStatusSummary.delivered) &&
        Objects.equals(this.bounced, channelLogStatusSummary.bounced) &&
        Objects.equals(this.inProgress, channelLogStatusSummary.inProgress) &&
        Objects.equals(this.opened, channelLogStatusSummary.opened) &&
        Objects.equals(this.clicked, channelLogStatusSummary.clicked) &&
        Objects.equals(this.unsubscribed, channelLogStatusSummary.unsubscribed) &&
        Objects.equals(this.complaints, channelLogStatusSummary.complaints) &&
        Objects.equals(this.inbound, channelLogStatusSummary.inbound) &&
        Objects.equals(this.manualCancel, channelLogStatusSummary.manualCancel) &&
        Objects.equals(this.notDelivered, channelLogStatusSummary.notDelivered);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channelName, recipients, emailTotal, smsTotal, delivered, bounced, inProgress, opened, clicked, unsubscribed, complaints, inbound, manualCancel, notDelivered);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChannelLogStatusSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChannelLogStatusSummary is not found in the empty JSON string", ChannelLogStatusSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChannelLogStatusSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChannelLogStatusSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChannelLogStatusSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChannelLogStatusSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChannelLogStatusSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChannelLogStatusSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ChannelLogStatusSummary>() {
           @Override
           public void write(JsonWriter out, ChannelLogStatusSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChannelLogStatusSummary read(JsonReader in) throws IOException {

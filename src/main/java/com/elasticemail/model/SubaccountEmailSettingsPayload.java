...
public class SubaccountEmailSettingsPayload {
  ...
  public SubaccountEmailSettingsPayload requiresEmailCredits(@javax.annotation.Nullable Boolean requiresEmailCredits) {
  ...
  public SubaccountEmailSettingsPayload emailSizeLimit(@javax.annotation.Nullable Integer emailSizeLimit) {
  ...
  public SubaccountEmailSettingsPayload dailySendLimit(@javax.annotation.Nullable Integer dailySendLimit) {
  ...
  public SubaccountEmailSettingsPayload maxContacts(@javax.annotation.Nullable Integer maxContacts) {
  ...
  public SubaccountEmailSettingsPayload enablePrivateIPPurchase(@javax.annotation.Nullable Boolean enablePrivateIPPurchase) {
  ...
  public SubaccountEmailSettingsPayload poolName(@javax.annotation.Nullable String poolName) {
  ...
  public SubaccountEmailSettingsPayload validSenderDomainOnly(@javax.annotation.Nullable Boolean validSenderDomainOnly) {

...
public class EmailView {
  ...
  public EmailView body(@javax.annotation.Nullable String body) {
    this.body = body;
    return this;
  }
  ...
  public EmailView subject(@javax.annotation.Nullable String subject) {
  ...
  public EmailView from(@javax.annotation.Nullable String from) {
    this.from = from;
    return this;
  }

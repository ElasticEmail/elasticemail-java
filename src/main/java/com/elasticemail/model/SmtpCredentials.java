...
public class SmtpCredentials {
  ...
  public SmtpCredentials accessLevel(@javax.annotation.Nullable AccessLevel accessLevel) {
  ...
  public SmtpCredentials name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public SmtpCredentials dateCreated(@javax.annotation.Nullable OffsetDateTime dateCreated) {
  ...
  public SmtpCredentials lastUse(@javax.annotation.Nullable OffsetDateTime lastUse) {
  ...
  public SmtpCredentials expires(@javax.annotation.Nullable OffsetDateTime expires) {
  ...
  public SmtpCredentials restrictAccessToIPRange(@javax.annotation.Nullable List<String> restrictAccessToIPRange) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to SmtpCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SmtpCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SmtpCredentials is not found in the empty JSON string", SmtpCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SmtpCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SmtpCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SmtpCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SmtpCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SmtpCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SmtpCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<SmtpCredentials>() {
           @Override
           public void write(JsonWriter out, SmtpCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SmtpCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SmtpCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SmtpCredentials
   * @throws IOException if the JSON string is invalid with respect to SmtpCredentials
   */
  public static SmtpCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SmtpCredentials.class);
  }

  /**
   * Convert an instance of SmtpCredentials to an JSON string
   *
   * @return JSON string
   */

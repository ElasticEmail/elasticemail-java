...
public class ApiKeyPayload {
  ...
  public ApiKeyPayload name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ApiKeyPayload accessLevel(@javax.annotation.Nonnull List<AccessLevel> accessLevel) {
  ...
  public void setAccessLevel(@javax.annotation.Nonnull List<AccessLevel> accessLevel) {
    this.accessLevel = accessLevel;
  }


  public ApiKeyPayload expires(@javax.annotation.Nullable OffsetDateTime expires) {
  ...
  public ApiKeyPayload restrictAccessToIPRange(@javax.annotation.Nullable List<String> restrictAccessToIPRange) {
  ...
  public ApiKeyPayload subaccount(@javax.annotation.Nullable String subaccount) {

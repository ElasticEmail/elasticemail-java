...
public class CampaignsApi {
    ...
    /**
     * Build call for campaignsAutomationByNameTriggerPost
     * @param name  (required)
     ...
     */
    public okhttp3.Call campaignsAutomationByNameTriggerPostCall(String name, String contactEmail, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/campaigns/automation/{name}/trigger"
    ...
    private okhttp3.Call campaignsAutomationByNameTriggerPostValidateBeforeCall(String name, String contactEmail, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling campaignsAutomationByNameTriggerPost(Async)");
        }

        // verify the required parameter 'contactEmail' is set
        if (contactEmail == null) {
            throw new ApiException("Missing the required parameter 'contactEmail' when calling campaignsAutomationByNameTriggerPost(Async)");
        }

        return campaignsAutomationByNameTriggerPostCall(name, contactEmail, _callback);
     ...
     */
    public void campaignsAutomationByNameTriggerPost(String name, String contactEmail) throws ApiException {
     ...
     */
    public ApiResponse<Void> campaignsAutomationByNameTriggerPostWithHttpInfo(String name, String contactEmail) throws ApiException {
        okhttp3.Call localVarCall = campaignsAutomationByNameTriggerPostValidateBeforeCall(name, contactEmail, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Trigger Automation for Contact (asynchronously)
     * Manually trigger an Automation for a contact. Required Access Level: ModifyAutomations
     * @param name  (required)
     * @param contactEmail  (required)
     ...
     */
    public okhttp3.Call campaignsAutomationByNameTriggerPostAsync(String name, String contactEmail, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = campaignsAutomationByNameTriggerPostValidateBeforeCall(name, contactEmail, _callback);
    ...
    /**
     * Build call for campaignsByNamePausePut
     * @param name Name of Campaign to pause (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call campaignsByNamePausePutCall(String name, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/campaigns/{name}/pause"
            .replace("{" + "name" + "}", localVarApiClient.escapeString(name.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call campaignsByNamePausePutValidateBeforeCall(String name, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling campaignsByNamePausePut(Async)");
        }

        return campaignsByNamePausePutCall(name, _callback);
     ...
     */
    public void campaignsByNamePausePut(String name) throws ApiException {
     ...
     */
    public ApiResponse<Void> campaignsByNamePausePutWithHttpInfo(String name) throws ApiException {
        okhttp3.Call localVarCall = campaignsByNamePausePutValidateBeforeCall(name, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Pause Campaign (asynchronously)
     * Pauses the specific campaign, cancelling emails that are waiting to be sent. Required Access Level: ModifyCampaigns
     * @param name Name of Campaign to pause (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call campaignsByNamePausePutAsync(String name, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = campaignsByNamePausePutValidateBeforeCall(name, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**

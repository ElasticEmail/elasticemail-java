...
import com.elasticemail.client.auth.Authentication;
import com.elasticemail.client.auth.HttpBasicAuth;
import com.elasticemail.client.auth.HttpBearerAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.elasticemail.com/v4";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/4.0.27/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.elasticemail.com/v4
     ...
     * @return a {@link com.elasticemail.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.elasticemail.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.elasticemail.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.elasticemail.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.elasticemail.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.elasticemail.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.elasticemail.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.elasticemail.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.elasticemail.client.ApiException If fail to serialize the request body object into a string
     */
